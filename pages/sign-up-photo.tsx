...
export default function SignUpPhoto() {
  ...
  const onSubmit = async () => {
    ...
    data.append("phoneNumber", "081212345678");
            ...
            <div>
              <div className="mb-20">
                <div className="image-upload text-center">
                  <label htmlFor="avatar">{imagePreview ? <img src={imagePreview} alt="upload" className="img-upload" /> : <Image src="/assets/icon/upload.svg" alt="upload" width={120} height={120} />}</label>
                  <input
                    id="avatar"
                    type="file"
                    name="avatar"
