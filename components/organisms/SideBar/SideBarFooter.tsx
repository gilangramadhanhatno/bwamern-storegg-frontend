        ...
        <div className="d-flex justify-content-between mb-20">
          <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <g mask="url(#mask0)">
              ...
              <path d="M31.25 28.75L31.25 42.5" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M25 33.75L25 42.5" stroke="#B7B0F4" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M18.75 37.5L18.75 42.5" stroke="#B7B0F4" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
