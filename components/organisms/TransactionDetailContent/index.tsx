...
export default function TransactionsDetailContent(props: TransactionDetailContentProps) {
  const { data } = props;
          ...
          <div className="main-content main-content-card overflow-auto">
            <section className="checkout mx-auto">
              ...
              <div className="d-md-block d-flex flex-column w-100">
                <a className="btn btn-whatsapp rounded-pill fw-medium text-white border-0 text-lg" href="https://wa.me/6281210657874?text=Saya%20sudah%20melakukan%20pembayaran" role="button">
                  WhatsApp ke Admin
                </a>
              </div>
            </section>
