      ...
      <div className="pt-md-50 pb-md-50 pt-30 pb-20">
        ...
        <div className="row justify-content-between">
          {nominals.map((nominal) => {
            return <NominalItem key={nominal._id} _id={nominal._id} coinQuantity={nominal.coinQuantity} coinName={nominal.coinName} price={nominal.price} onChange={() => onNominalItemChange(nominal)} />;
          })}
          ...
          <div className="row justify-content-between">
            {payments.map((payment) => {
              return payment.banks.map((bank) => {
                return <PaymentItem key={bank._id} bankID={bank._id} type={payment.type} bankName={bank.bankName} onChange={() => onPaymentItemChange(payment, bank)} />;
              });
            })}
            <div className="col-lg-4 col-sm-6"></div>
          </div>
